...
/// request headers and in lookup-like replies such as [`crate::EntryOut`].
///
...
///
/// In the FUSE protocol, every reply that contains an [`crate::EntryOut`]
...
impl LookupCount {
    ...
    /// [`crate::EntryOut`] reply.
    pub const fn initial() -> Self {
        Self(AtomicU64::new(1))
    }

    /// Acquires one lookup reference after receiving an `EntryOut` reply.
    pub fn acquire(&self) {
