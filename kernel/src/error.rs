...
impl From<VirtioDeviceError> for Error {
    fn from(virtio_error: VirtioDeviceError) -> Self {
        match virtio_error {
            ...
            VirtioDeviceError::QueueUnknownError | VirtioDeviceError::TransportUnknownError => {
                Error::with_message(Errno::EIO, "Unknown error of queue or transport")
            }
            VirtioDeviceError::RequestIdExhausted => {
                Error::with_message(Errno::EIO, "Request IDs are exhausted")
            }
            ...
            VirtioDeviceError::ResourceAllocError => Error::with_message(
                Errno::EIO,
